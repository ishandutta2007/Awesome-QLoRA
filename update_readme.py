...
# Add Banner, Badges, and SEO text at the top
...
# If title exists, replace it, else prepend
...
<picture>
<source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=ishandutta2007/Awesome-QLoRA&type=date&theme=dark&legend=bottom-right" />
<source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=ishandutta2007/Awesome-QLoRA&type=date&legend=bottom-right" />
<img alt="Star History Chart" src="https://api.star-history.com/chart?repos=ishandutta2007/Awesome-QLoRA&type=date&legend=bottom-right" />
</picture>
</a>
</div>
"""
...
# Replace chartrepos with chart?repos (although we used chart?repos above, let's fix any existing)
